      ...
      <div className="flex-1 bg-orange-50 p-8">
        ...
        <div className="flex justify-center items-center">
          ...
          <button  className=" ml-auto bg-black text-white px-4 py-2 rounded">Editar</button>
            ...
            <div className="mb-4">
              <strong>Nombre:</strong> John Doe <i> diputado</i> 
            </div>
            <div className="mb-4">
              <strong>Bio:</strong> Una breve descripción de los ideales del diputado.
            </div>
           
             
            <button style={{ marginLeft: '16px' }} className=" mb-4 bg-black text-white px-4 py-2 rounded">Subir iniciativa</button>
             <button style={{ marginLeft: '16px' }} className="mb-4 bg-black text-white px-4 py-2 rounded">Historial iniciativas aprobadas/rechazadas</button>
             <button style={{ marginLeft: '16px' }} className="mb-4 bg-black text-white px-4 py-2 rounded">Historial votaciones aprobadas/rechazadas</button>
           
          </div>
          <div className="ml-8">
            <img src="diputado.png" alt="Profile" className="w-48 h-48 rounded-full object-cover" />
          </div>
        </div>
      </div>
    </div>
